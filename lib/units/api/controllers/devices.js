...
/* ------------------------------------ PRIVATE FUNCTIONS ------------------------------- */
function publishDeviceNoteEvent(deviceId, note) {
  // const message = 'lalala'
  // publisher.connect().then(r => {
  //   publisher.publish('my-channel', message).then(r => {
  //     console.log('publishDeviceNoteEvent', r)
  //   }).catch(e => {
  //     console.log('publishDeviceNoteEvent', e)
  //   })
  // })
}
...
function test() {
  publishDeviceNoteEvent('test', 'test123')
}
